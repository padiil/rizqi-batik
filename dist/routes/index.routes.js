import { berandaPage, belanjaPage, deskripsiPage, checkoutPage, kontakPage, keranjangPage, productDetailPage, adminProductPage, adminLoginPage, loginAdmin, logoutAdmin, addProduct, multerUpload, deleteProduct, updateProduct, adminProductDetail, } from "../controllers/index.controllers.js";
import { isAuthenticated, redirectIfAuthenticated, } from "../middlewares/auth.middleware.js";
export const routes = (app) => {
    ...
    app.post("/admin/products/add", // Your route to add a product
    ...
    app.patch("/admin/products/update/:id", multerUpload, // For handling image upload
    updateProduct);
